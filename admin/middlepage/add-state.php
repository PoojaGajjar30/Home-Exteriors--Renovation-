                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add State</h3>                                
                                    <form id="validate" role="form" class="form-horizontal" action="index.php?page=addstate" method="POST">
                                    <?php 

                            $sql = "select * from `state` where State_Id = '".$_GET['uid']."' ";
                            ...
                            <input type="hidden" name="uid" value="<?php echo $_GET['uid']; ?>" />                            
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="statename" class="form-control" value="<?php echo $row['State_name']; ?>"/>
                           ...
                           <?php }else { ?>
                            <input type="submit" class="btn btn-primary submit-btn" name="addstate" value="Insert Your Data">
                            <?php }?>
                                        </div>                                                                
                                    </form>
