                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <?php
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $serviceoffer = $row['service_offer'];
                                                    $servicedescriptions = $row['service_descriptions'];
                                                    $servicepic = $row['service_photo'];
                                                    $doi = $row['DOI'];
                                            ...
                                            <tr>
                                                    ...
                                                    <td><?php echo $serviceamount?></td>
                                                    <td><?php echo $servicelocation?></td>
                                                    <td><?php echo $serviceoffer?></td>
                                                    <td><?php echo $servicedescriptions?></td>
                                                    <td><img src="../serviceprovider/servicepic/<?php echo $servicepic?>" height="100px" width="200px"></td>
                                                    <td><?php echo $doi?></td>
                                                    ...
                                                    <td><a href="index.php?page=add-service&uid=<?php echo $service_id; ?>">Update</a> | <a href="index.php?page=addservice&did=<?php echo $service_id; ?>">Delete</a></td>
                                            </tr>
                                        <?php } ?>
                                        </table>
                                    </div>
