        ...
        <!-- START VALIDATIONENGINE PLUGIN -->
            <div class="panel panel-default">
                <div class="panel-body">                                    
                    ...
                    <form class="form-horizontal" action="index.php?page=addserviceprovider" method="post"> 
                    <?php 

                            $sql = "select * from `service_provider_profile_tbl` where service_provider_Id = '".$_GET['uid']."' ";
                        ...
                        <label class="col-md-3 control-label">City:</label>
                            <div class="col-md-9">
                                <input type="text" name="city" class="form-control" value="<?php echo $row['city']; ?>"/>   
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">About Profession:</label>
                                            <div class="col-md-9">
                                                <input type="text" name="aboutprofession" class="form-control" value="<?php echo $row['about profession']; ?>"/>
                           ...
                           <?php }else { ?>
                            <input type="submit" class="btn btn-primary submit-btn" name="addserviceprovider" value="Insert Your Data">
                                        <?php }?>
                                        </div>                                                                
                                    </form>
                                </div>
