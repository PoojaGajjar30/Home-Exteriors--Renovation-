			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-9 col-md-8">
						<form action="index.php?page=provider-profile-action" method="post" enctype="multipart/form-data">
							<div class="widget">
								...
								<div class="row">
									...
									<div class="form-group col-xl-12">
										<div class="media align-items-center mb-3">
											<?php if(isset($_SESSION['providerprofile'])){?>
											<div class="alert alert-primary" role="alert"><?php echo $_SESSION['providerprofile']; unset($_SESSION['providerprofile']); ?>	
											</div>
										<?php } ?>
										
										<img class="user-image" src="providerpic/<?php echo $fetch['profile_pic'];?>" alt="">
										
										<input type="file" name="providerpi">
							...
							<div class="row">
								...
								<div class="form-group col-xl-6">
									...
									<input class="form-control" type="text" name="mobilenum" value="<?php echo $fetch['mobilenum'];?>">
								</div>
								<div class="form-group col-xl-6">
									<label class="mr-sm-2">Date of birth</label>
									<input type="date" class="form-control provider_datepicker" autocomplete="off" name="dob" value="<?php echo $fetch['dob'];?>">
								</div>
								<div class="form-group col-xl-6">
								...
								<div class="form-group col-xl-6">
									...
									<input type="text" class="form-control" autocomplete="off" name="profession" value="<?php echo $fetch['profession'];?>">
								</div>
								<div class="form-group col-xl-6">
									<label class="mr-sm-2">Description Of service</label>
									<input type="text" class="form-control" autocomplete="off" name="aboutprofession" value="<?php echo $fetch['about profession'];?>">
								</div>
								<div class="form-group col-xl-6">
									<label class="mr-sm-2">Experience</label>
									<input type="text" class="form-control" autocomplete="off" name="experience" value="<?php echo $fetch['experience'];?>">
								</div>
								<div class="col-xl-12">
								...
								<div class="form-group col-xl-12">
									<button class="btn btn-primary pl-5 pr-5" name="providerprofile" type="submit">Update</button>
								</div> 
							</div>
						</form>
					</div>
